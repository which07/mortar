 ...
 *      Quartiles (0, 25, 50, 75, 100th percentiles),
 *      Number of null appearences,
 *      Percentage null,
 *      Minimum value,
 *      Maximum value,
 *      Range of values (Max - Min),
 *      Value (length of item for chararrays, bytearrays, and complex types)
 *      Original Value,
 *      Type,
 *      Number of times Value appeared in the data
 *     )
 *
 * data: {anything}
...
REGISTER 's3://hawk-dev-software-mirror/datafu/datafu-0.0.10.jar';
REGISTER 's3://hawk-dev-software-mirror/bacon-bits/udfs/java/bacon-bits-0.1.0.jar';
